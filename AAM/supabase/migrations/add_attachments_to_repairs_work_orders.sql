-- Let service reports / documents be attached to repairs and work orders, so
-- older service, repair, and work-done-on-instruments paperwork can simply be
-- dropped in against the record it belongs to.
